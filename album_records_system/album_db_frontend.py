...
label0 = Label(root, text="Album Database System").grid(row=0, column=1, columnspan=3) #grid your objects properly

button1 = Button(root, text="Title: ").grid(row=2, column=1) #grid your objects properly
button2 = Button(root, text="Artist: ").grid(row=2, column=3)
button3 = Button(root, text="Release Year: ").grid(row=3, column=1)
button4 = Button(root, text="Record Label: ").grid(row=3, column=3)
